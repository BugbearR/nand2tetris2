    ...
    class HackAssembler {
        ...
        assemblePass1() {
            ...
            while (this.parser.hasMoreLines()) {
                ...
                if (this.parser.instructionType() === "A_COMMAND" || this.parser.instructionType() === "C_COMMAND") {
                    ...
                    this.symbolTable.addEntry(this.parser.symbol(), romAddr);
                }
            }
            return romAddr;
        }
        ...
        assembleACommand() {
            ...
            if ((addr = this.tryParseNumber(symbol)) != null) {
                ...
                addr = this.symbolTable.getAddress(symbol);
            }
            else {
                this.symbolTable.addEntry(symbol, this.symbolAddr);
                addr = this.symbolAddr;
                this.symbolAddr++;
            }
